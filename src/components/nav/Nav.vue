...
const openTwitter = () => {
    window.open('https://twitter.com/ibcCoin_org', '_blank')
}
const openWeibo = () => {
    window.open('https://twitter.com/ibcCoin_org', '_blank')
}
            ...
            <div class="flex">
                <div class="flex items-center hover:cursor-pointer normal-case ml-0 md:ml-5">
                    ...
                    <div class="text-base text-l font-bold text-primary lg:text-2xl">
                        <span>Arbitrum Odyssey Task</span>
                    </div>
                </div>
            </div>

            <div class="flex">
                <!-- <button class="flex items-center mr-2 md:mr-5 normal-case">
                    <span class="mt-4 inline-flex justify-center items-center sm:ml-auto sm:mt-0 sm:justify-start">
                        ...
                        <div @click="openWeibo" class="tooltip tooltip-primary ml-3" data-tip="Discord">
                            <svg
                                t="1649515722394"
                                class="icon h-8 w-8"
                                ...
                                height="32"
                            >
                                <path d="M0 512a512 512 0 1 0 1024 0A512 512 0 1 0 0 512z" fill="#343c4d" p-id="1550"></path>
                                <path d="M190.915 234.305h642.169v477.288H190.915z" fill="#FFFFFF" p-id="1551"></path>
                                <path
